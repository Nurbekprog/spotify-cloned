...
import { removeFromLibrary } from "../app/appSlice";
        ...
        <header className="text-white py-3 bg-gradient-to-b from-indigo-800 pt-3 px-5 pb-20 rounded-md">
          ...
          <div className="bottom mt-20 flex items-end gap-6">
            ...
            <div className="content flex flex-col">
              <span className="uppercase font-semibold">Public library</span>
              <h1 className="capitalize font-bold text-7xl mt-7 mb-10">Your Library</h1>
              <div className="flex flex-col gap-3">
                <p className="font-semibold text-xl text-zinc-500"><span className="text-white text-xl font-semibold">Made for you</span> | <span className="text-zinc-500 text-xl font-semibold">{library.length} songs, 7hr 17 min</span></p>
              </div>
            </div>
          </div>
        </header>
